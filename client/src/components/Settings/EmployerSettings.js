                    ...
                    const upload = storage
                        .child(
                            `profilePics/${
                                ...
                                profilePictureInput.name.match(fileRegex)[0]
                            }`
                        )
                ...
                if (resumeInput instanceof File) {
                    ...
                    const upload = storage
                        .child(
                            `resumes/${
                                this.props.currentSignedInUser.uid
                            }/resume${resumeInput.name.match(fileRegex)[0]}`
                        )
                            ...
                            <Security>
                                ...
                                <Label width="100%">
                                    ...
                                    this.state.editing ? (
                                        ...
                                        >
                                            <br />
                                            Please additionally enter your
                                            current password in the "Current
                                            Password Field"
                                        </span>
                                    ) : (
                                        ''
                    ...
                    <Route
                        ...
                        render={props => (
                            <PostContainer>
                                {this.state.posts ? (
                                    <Posts>
                                        {Object.values(this.state.posts).map(
                                            (post, i) => (
                                                <Job key={i}>
                                                    {' '}
                                    ...
                                    <Posts>
                                        ...
                                        {this.props.currentSignedInUser.paid ? (
                                            ...
                                            <Premium>
                                                ...
                                                <h1>
                                                    You haven't listed any jobs
                                                    yet!
                                                </h1>
                                                <h1>
                                                    Pay for a Premium account to
                                                    add one.
                                                </h1>
